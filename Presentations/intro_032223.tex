...
\begin{itemize}
    ...
    \[Y_i(0) \text{ and } Y_i(1).\]
    % This means the outcome of $Y_i$ if i receives A = 0, and the outcome of $Y_i$ if 
    % $A = 1$.
    % Notice that the potential outcomes do NOT depend on the treatment assignment at all.
\end{itemize}
